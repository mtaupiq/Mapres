	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
				<img src="{{asset('img/logo.png')}}" class="img-responsive" width="80%">
			</div>
			<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9" style="size:16pt;">
				<b>UNIVERSITAS UMAR UTSMAN</b>
		...
		<!-- <div class="row">
			<div class="col-xs-11 col-sm-11 col-md-11 col-lg-11 bg-success" style="size:14pt;">
				<center><b>DATA PESERTA MAHASISWA BERPRESTASI</b></center>
			</div>
		</div><br> -->
