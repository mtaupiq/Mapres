                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="jk" value="admin" checked>Admin
                                        </label>
                                        <label>
                                            <input type="radio" name="jk" value="Penilai">Penilai
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a class="btn btn-default" href="{{ url('userdata')}}" role="button">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
